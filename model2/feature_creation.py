...
7: sentence tf-idf
"""
def main(input_file, input_file2, output_file):
    ...
    with open(input_file, "r") as input_f:
        for line in input_f:
            ...
            if line.strip() == "<PARAGRAPH>":
                paragraph_info.append((current_num_words_in_para, current_num_lines_in_para))
        ...
        for line in input_f:
            if line.strip() == "<PARAGRAPH>":
                ...
                features[3] = current_num_lines_in_para / paragraph_info[current_paragraph][1]
...
if __name__ == '__main__':
    ...
    main(input_file, input_file2, output_file)